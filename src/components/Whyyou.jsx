...
const Whyyou = () => {
  return (
    <section className=" lg:px-[70px] md:px-[70px]  text-center  ">
   ...
   flex-col min-h-[70vh] gap-5" >
{
 ...
 return  <div className=" p-7 flex lg:justify-between"   key={item.title} > 
 <Card
      shadow={false}
      className="   lg:h-[25rem]  h-[28rem]    overflow-hidden text-center"
